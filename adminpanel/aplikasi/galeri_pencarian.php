...
<div class="isikanan"><!--Awal class isi kanan-->
		...
		<table class="tabel" id="results">
			...
			$cari = htmlentities(htmlspecialchars($cari), ENT_QUOTES);
				$no=1;
				$galeri=mysql_query("SELECT * FROM sh_galeri, sh_album WHERE sh_galeri.id_album=sh_album.id_album AND nama_galeri LIKE '%$cari%' ORDER BY id_galeri DESC");
			...
			<tr class="tabel"><td class="tabel" colspan="6"><b>DATA GALERI DENGAN KATA KUNCI <u><?php echo "$cari";?></u> TIDAK DITEMUKAN</b></td></tr>
			<?php }
			?>
