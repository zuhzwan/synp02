<?php
$database="aplikasi/database/staff.php";
switch($_GET['pilih']){
default: ?>
<h3>Staff</h3>
<div class="isikanan"><!--Awal class isi kanan-->
		...
		<table class="tabel" id="results">
			...
			<?php
			$no=1;
			$staff=mysql_query("SELECT * FROM sh_guru_staff, sh_jabatan WHERE sh_guru_staff.id_jabatan=sh_jabatan.id_jabatan AND posisi='staff' ORDER BY id_gurustaff DESC");
			...
			<tr class="tabel"><td class="tabel" colspan="8"><b>DATA STAFF BELUM TERSEDIA</b></td></tr>
    ...
    //--></script>
		...
		case "tambah":
			include "aplikasi/staff_tambah.php";
		break;
		
		case "edit":
			include "aplikasi/staff_edit.php";
		break;
		
		case "jenkel":
			include "aplikasi/staff_jenkel.php";
		break;
		
		case "pencarian":
			include "aplikasi/staff_pencarian.php";
		}
		?>
