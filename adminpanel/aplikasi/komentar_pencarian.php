...
<div class="isikanan"><!--Awal class isi kanan-->
		...
		<table class="tabel" id="results">
			...
			$no=1;
			if($_SESSION[leveluser]=='Super Admin'){
			$komentar=mysql_query("SELECT * FROM sh_komentar, sh_berita WHERE sh_komentar.id_berita=sh_berita.id_berita AND nama_komentar LIKE '%$cari%' ORDER BY id_komentar DESC");
			}
			else {
			$komentar=mysql_query("SELECT * FROM sh_komentar, sh_berita WHERE sh_komentar.id_berita=sh_berita.id_berita AND nama_komentar LIKE '%$cari%' AND sh_berita.s_username='$_SESSION[adminsh]' ORDER BY id_komentar DESC");
			}
