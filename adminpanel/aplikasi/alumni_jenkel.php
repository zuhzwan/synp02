...
<div class="isikanan"><!--Awal class isi kanan-->
		...
		<table class="tabel" id="results">
			...
			<?php
			$no=1;
			$alumni=mysql_query("SELECT * FROM sh_siswa WHERE jenkel='$_GET[kode]' AND status_siswa='0' ORDER BY nama_siswa");
			...
			<tr class="tabel"><td class="tabel" colspan="8"><b>DATA ALUMNI DENGAN JENIS KELAMIN <u><?php
