...
<div class="isikanan"><!--Awal class isi kanan-->
		...
		<table class="tabel" id="results">
			...
			<?php
				$no=1;
				$galeri=mysql_query("SELECT * FROM sh_galeri, sh_album WHERE sh_galeri.id_album=sh_album.id_album AND sh_galeri.id_album='$_POST[album]' ORDER BY id_galeri DESC");
			...
			<?php
			$nama_album=mysql_query("SELECT * FROM sh_album WHERE id_album='$_POST[album]'");
