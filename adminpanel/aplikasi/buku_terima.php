...
<div class="isikanan"><!--Awal class isi kanan-->
		...
		<table class="tabel" id="results">
			...
			<?php
				$no=1;
				$bukutamu=mysql_query("SELECT * FROM sh_buku_tamu WHERE status='1' ORDER BY id_bukutamu DESC");
			...
			<tr class="tabel">
				...
				<td class="tabel">
					<div class="hapusdata"><a href="<?php echo "$database?pilih=terima&untukdi=hapus&id=$b[id_bukutamu]";?>">hapus</a></div>
					<div class="editdata"><a href="<?php echo "?pilih=edit&id=$b[id_bukutamu]";?>">edit</a></div>
					<div class="bataldata"><a href="<?php echo "$database?pilih=terima&untukdi=tolak&id=$b[id_bukutamu]";?>">tolak</a></div>
			...
			<tr class="tabel"><td class="tabel" colspan="6"><b>DATA BUKU TAMU YANG DITERIMA BELUM TERSEDIA</b></td></tr>
			<?php }
			?>
