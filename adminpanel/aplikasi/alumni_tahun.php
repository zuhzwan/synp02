...
<div class="isikanan"><!--Awal class isi kanan-->
		...
		<table class="tabel" id="results">
			...
			<?php
			$no=1;
			$alumni=mysql_query("SELECT * FROM sh_siswa WHERE tahun_lulus='$_POST[tahun]' AND status_siswa='0' ORDER BY nama_siswa");
			...
			<tr class="tabel"><td class="tabel" colspan="8"><b>DATA ALUMNI DENGAN TAHUN LULUS <u><?php echo $_POST[tahun]?></u> TIDAK DITEMUKAN</b></td></tr>
			<?php }
			?>
