...
<div class="isikanan"><!--Awal class isi kanan-->
		...
		<table class="tabel" id="results">
			...
			<?php
			$no=1;
			$materi=mysql_query("SELECT * FROM sh_materi, sh_mapel WHERE sh_materi.id_mapel=sh_mapel.id_mapel AND sh_materi.id_mapel='$_POST[mapel]' ORDER BY id_materi DESC");
