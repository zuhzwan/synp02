<?php
$database="aplikasi/database/bukutamu.php";
switch($_GET['pilih']){
default: ?>
<h3>Buku Tamu</h3>
<div class="isikanan"><!--Awal class isi kanan-->
		...
		<?php echo "<form method='POST' action='$database?pilih=bukutamu&untukdi=hapusbanyak'>"; ?>
		...
		<table class="tabel" id="results">
			...
			<?php
				$no=1;
				$bukutamu=mysql_query("SELECT * FROM sh_buku_tamu ORDER BY id_bukutamu DESC");
			...
			<tr class="tabel">
				...
				<td class="tabel">
					<div class="hapusdata"><a href="<?php echo "$database?pilih=bukutamu&untukdi=hapus&id=$b[id_bukutamu]";?>">hapus</a></div>
					<div class="editdata"><a href="<?php echo "?pilih=edit&id=$b[id_bukutamu]";?>">edit</a></div>
					<?php if($b[status]=='1'){ ?>
					<div class="bataldata"><a href="<?php echo "$database?pilih=bukutamu&untukdi=tolak&id=$b[id_bukutamu]";?>">tolak</a></div>
					<?php }
					else { ?>
					<div class="terbitdata"><a href="<?php echo "$database?pilih=bukutamu&untukdi=terima&id=$b[id_bukutamu]";?>">terima</a></div>
					<?php } ?>
				</td>
			</tr>
			<?php
			...
			<tr class="tabel"><td class="tabel" colspan="6"><b>DATA TAMU BELUM TERSEDIA</b></td></tr>
			<?php }
			?>
    ...
    //--></script>
		...
		case "tambah":
			include "aplikasi/buku_tambah.php";
		break;
		
		case "edit":
			include "aplikasi/buku_edit.php";
		break;
		
		case "pencarian":
			include "aplikasi/buku_pencarian.php";
		break;
		
		case "terima":
			include "aplikasi/buku_terima.php";
		break;
		
		case "tolak":
			include "aplikasi/buku_tolak.php";
		}
		?>
