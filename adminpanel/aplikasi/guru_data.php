<?php
$database="aplikasi/database/guru.php";
switch($_GET['pilih']){
default: ?>
<h3>Guru</h3>
<div class="isikanan"><!--Awal class isi kanan-->
		...
		<table class="tabel" id="results">
			...
			<?php
			$no=1;
			$guru=mysql_query("SELECT * FROM sh_guru_staff, sh_mapel WHERE sh_guru_staff.id_mapel=sh_mapel.id_mapel AND posisi='guru' ORDER BY id_gurustaff DESC");
			...
			<tr class="tabel"><td class="tabel" colspan="8"><b>DATA GURU BELUM TERSEDIA</b></td></tr>
			<?php }
			?>
    ...
    //--></script>
		...
		case "tambah":
			include "aplikasi/guru_tambah.php";
		break;
		
		case "edit":
			include "aplikasi/guru_edit.php";
		break;
		
		case "jenkel":
			include "aplikasi/guru_jenkel.php";
		break;
		
		case "pencarian":
			include "aplikasi/guru_pencarian.php";
		}
		?>
