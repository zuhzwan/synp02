...
<div class="isikanan"><!--Awal class isi kanan-->
		...
		<table class="tabel" id="results">
			...
			$no=1;
			if($_SESSION['leveluser']=='Super Admin'){
			$databerita=mysql_query("SELECT * FROM sh_berita,sh_users, sh_kategori WHERE sh_berita.s_username=sh_users.s_username AND sh_berita.id_kategori=sh_kategori.id_kategori AND judul_berita LIKE '%$cari%' ORDER BY id_berita DESC");
			}
			else {
			$databerita=mysql_query("SELECT * FROM sh_berita,sh_users, sh_kategori WHERE sh_berita.s_username=sh_users.s_username AND sh_berita.id_kategori=sh_kategori.id_kategori AND judul_berita LIKE '%$cari%' AND sh_berita.s_username='$_SESSION[adminsh]' ORDER BY id_berita DESC");
			}
