...
<img src="file/tema/edisi_spesial/css/img/e-learning.png">
<?php
include "file/tema/edisi_spesial/login.php";
?>
</div>

<div class="kotakSidebar">
			<img src="file/tema/edisi_spesial/css/img/polling.png">
			<?php
			...
			<img src="file/tema/edisi_spesial/css/img/ym.png">
			...
			<img src="file/tema/edisi_spesial/css/img/link.png">
			...
			<img src="file/tema/edisi_spesial/css/img/statistik.png">
			...
			<tr><td style="padding: 5px 0px 5px 10px"><?php echo "$totalhits";?></td>
				<td style="padding: 5px 0px 5px 10px"><img src="file/tema/edisi_spesial/css/img/hari_ini.png"></td>
