...
<img src="file/tema/edisi_spesial_gambar/css/img/e-learning.png">
<?php
...
<div class="kotakSidebar">
			<img src="file/tema/edisi_spesial_gambar/css/img/polling.png">
			<?php
			...
			<img src="file/tema/edisi_spesial_gambar/css/img/ym.png">
			...
			<img src="file/tema/edisi_spesial_gambar/css/img/link.png">
			...
			<img src="file/tema/edisi_spesial_gambar/css/img/statistik.png">
			...
			<tr><td style="padding: 5px 0px 5px 10px"><?php echo "$totalhits";?></td>
				<td style="padding: 5px 0px 5px 10px"><img src="file/tema/edisi_spesial_gambar/css/img/hari_ini.png"></td>
