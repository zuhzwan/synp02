...
?>		
		...
		<div id="headlineFrame">
			...
			<div id="slides">
				<div class="slides_container">
					...
					?>
					<div class="slide">
					<a href="<?php echo "?p=detberita&id=$sb[id_berita]"; ?>" title=""><img src="images/<?php echo $sb[gambar_kecil]?>" width="648" height="280" alt="Slide 1"></a>
						<div class="caption" style="bottom:0">
							...
							<?php echo $isi ?><a href="<?php echo "?p=detberita&id=$sb[id_berita]"; ?>" style="color: #ffff00">Baca selengkapnya...</a></p>
						</div>
					</div>
					<?php } ?>
		...
		<div class="clear"></div>
			...
			<div id="kecil" style="width:278px; margin-left: 0px">
